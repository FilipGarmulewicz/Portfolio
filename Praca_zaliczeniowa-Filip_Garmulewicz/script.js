...
function createHeader(firstLine, secondLine) {
  ...
  function closeBurger() {
    if (window.innerWidth > 1024) {
      burgerUl.style.display = "none";
    } else if (window.innerWidth < 1024 && !isClosed) {
      burgerUl.style.display = "flex";
    }
  }
...
function createHome() {
  ...
  imgHome.src = "Images/male-7275449_1280 1.png";
  ...
  imgSmall.src = "Images/2male-7275449_1280 1.png";
  ...
  Mauris quis urna mauris. Vestibulum semper dolor purus, malesuada rhoncus urna facilisis vel. Vestibulum lorem dui, molestie ultrices porttitor a, sodales sit amet neque. 
  ...
  Proin efficitur interdum neque at congue.`;
...
function createAbout() {
  ...
  imgAbout.src = "Images/male-7275449_1280 1.png";
  aboutPage.appendChild(imgAbout);

  const imgAboutSmall = document.createElement("img");
  imgAboutSmall.src = "Images/2male-7275449_1280 1.png";
...
function createContact() {
  ...
  form.appendChild(messageBtn);
  messageBtn.innerText = "Send message";
  // messageBtn.name = "intent";
  // messageBtn.value = "save";
  ...
  function sendMessage(e) {
    ...
    } else if (input3.value.length > 100) {
    ...
    //   const submitter = document.querySelector(".message_btn");
    //   const formData = new FormData(form, submitter);

    //   const okDiv = document.createElement("div");
    //   main.appendChild(okDiv);
    //   okDiv.className = "ok";
    //   okDiv.id = "output";

    //   for (const [key, value] of formData) {
    //     okDiv.textContent += `${key}: ${value}`;
    //   }
    // }
...
function createProjects() {
  ...
  function addProject() {
    ...
    } else if (inputModal1.value.length > 30) {
